...
public class Auto_OLD {
    ...
    public Auto_OLD(String marca, String modello, String id, String descrizione, double prezzo, int height, int width,
    ...
    public static void main(String[] args) {
        Auto_OLD test = new Auto_OLD("Audi", "A2", "123", "fancy ...", 134.55,
                10, 12, 14, 16,  110);
        try {
